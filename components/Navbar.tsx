        ...
        <div className='w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4'>
            <div className='max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between'>
                ...
                <div className='hidden mdl:inline-flex items-center gap-7 '>
                    <ul className='flex text-[13px] gap-7'>
                        <Link href="#home"
                            ...
                            <motion.li
                                ...
                                transition={{ duration: 0.1,delay:0.4 }}>Home</motion.li>
                        </Link>
                        <Link href="#about"
                            className='flex items-center gap-1 font-medium text-textDark hover:text-textGreen 
                            cursor-pointer duration-300 nav-link'>
                    ...
                    <a href='/assets/Payslip.pdf' target="_blank">
                    <motion.button initial={{ opacity: 0 }}
                                animate={{  opacity: 1 }}
                                transition={{ delay:0.5 }}
                                className='px-4 py-2  rounded-md text-textGreen border hover:bg-hoverColor duration-300'
                    >Resume</motion.button>
                    </a>
                </div>
                {/* Small icon */}
                <div className='w-6 h-5 flex flex-col justify-between items-center mdl:hidden text-4xl text-textGreen
