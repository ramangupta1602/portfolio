        ...
        <section id='about' className='max-w-containerSmall mx-auto py-10 lgl:py-32 flex flex-col gap-8'>
            ...
            <div className='flex flex-col lgl:flex-row gap-16'>
                <div className='w-full lgl:w-2/3 text-base text-textDark font-medium flex flex-col gap-4'>
                    <p>
                        Hello! My name is Raman Gupta and I enjoy creating things that
                        live on the internet. My interest in web development started back in
                        2021 when I decided to try editing custom Tumblr theme - turns out
                        hacking together a custom reblog button taught me a lot about HTML &
                        CSS!
                    </p>
                    <p>
                        Fast-forward to today, and I had the privillage of working at an
                        advertising agency, a start-up,{" "}
                        <span className='text-textGreen'>
                            a huge corporation, and a student-led design studio.
                        </span>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis,
                        velit placeat deserunt {" "}
                        <span className='text-textGreen'>
                            ab adipisicing elit. Blanditiis,
                        </span>
                    </p>
                    <p>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Delectus
                        quod officiis ad itaque molestias expedita, quas numquam? Vero
                        aliquam inventore
                    </p>
